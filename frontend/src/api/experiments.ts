...
export interface ExperimentDetail extends Experiment {
  galvano_system: {
    ...
    ftheta?: {
      manufacturer?: string; model_name?: string; serial_number?: string;
      ftheta_focal_mm?: number; remarks?: string;
    } | null;
    optics?: {
      manufacturer?: string; remarks?: string;
      entries: Array<{
        optics_role?: string; collimator_focal_mm?: number; serial_number?: string;
        doe?: {
          manufacturer?: string; model_name?: string; serial_number?: string;
          profile_shape?: string; remarks?: string;
        } | null;
        laser_device?: {
          manufacturer?: string; model_name?: string; serial_number?: string;
          beam_structure?: string; remarks?: string;
          laser_beam?: {
            wavelength_nm?: number; numerical_aperture?: number; m2_value?: number;
            bpp_mm_mrad?: number; remarks?: string;
            entries: Array<{
              beam_type?: string; core_diameter_um?: number;
  ...
  experiment_material: {
    ...
    material_state?: {
      ...
      surface_condition?: string; remarks?: string;
      material?: {
  ...
  shielding_condition: {
    ...
    nozzle_type?: string; nozzle_diameter_mm?: number; nozzle_distance_mm?: number;
    nozzle_angle_deg?: number; remarks?: string;
  } | null;
  result: {
    oct_depth_mm?: number;
    oct_surface_csv_path?: string; oct_depth_csv_path?: string; oct_result_csv_path?: string;
    cross_section_depth_mm?: number;
    spatter_flag?: boolean; spatter_severity?: number;
    gap_opening_flag?: boolean; crack_flag?: boolean; crack_severity?: number;
    glass_contamination?: boolean; surface_contamination?: boolean; penetration_flag?: boolean;
    remarks?: string;
  } | null;
  observation: {
    observer_name?: string; observation_datetime?: string; comment?: string; remarks?: string;
  } | null;
  file: {
    remarks?: string;
  } | null;
...
export const fetchExperiments = (params?: { skip?: number; limit?: number; remarks?: string }) =>
